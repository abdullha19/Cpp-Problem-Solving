...
int main() {
    ...
    cout << "\nMaximum Number in the Array: " << GetMaxNumber(arr, arrLength) << endl;
    cout << "Minimum Number in the Array: " << GetMinNumber(arr, arrLength) << endl;
    cout << "Sum of Array Elements: " << sumArray(arr, arrLength) << endl;
    cout << "Average of Array Elements: " << GetAverage(arr, arrLength) << endl;
